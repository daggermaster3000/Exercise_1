...
NOTES/USAGE:
    - Run it from your IDE or alternatively from a command prompt by activating 
      your environment and running with: python Ex3_Visual.py
...
class Retina:
    ...
    def get_RFS(self):
        ...
        r_eye = 1.25e-2 # m
        px_to_m = self.height / display_resolution
        m_to_px = 1 / px_to_m
...
def dog_filter(dim,sigma1, sigma2):
    ...
    """
    dim = 8*sigma1  # creating a min kernel size of 3 would be better
